...
// Standalone tool to derive and print the DRACHMA mainnet genesis block. It
// should be compiled alongside the consensus sources to guarantee that the
// printed values match the binary-embedded constants.
...
int main()
{
    const consensus::Params& params = consensus::Mainnet();
